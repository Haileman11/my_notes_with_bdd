...
void main() {
  ...
  group('''View notes''', () {
    testWidgets('''Should view the notes list when app is opened''', (tester) async {
      try {
    ...
    testWidgets('''Should see a message saying there are no saved notes if notes list is empty''', (tester) async {
      try {
        await bddSetUp(tester);
